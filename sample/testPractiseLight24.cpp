...
void render() {
    ...
    glUniform1f(glGetUniformLocation(shaderId, "light.linear"), 0.09f);
    glUniform1f(glGetUniformLocation(shaderId, "light.quadratic"), 0.032f);
    ...
    for (size_t i = 0; i < 10; i++) {
        ...
        model = glm::rotate(model,             ((float)glfwGetTime()) * glm::radians(i * 20.0f + 5.0f), 
