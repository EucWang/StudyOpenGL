...
int PointShadow::practise(const char * projectDir) {
	...
	WindowHelper helper("point shadow", Camera(glm::vec3(0.0f, 3.0f, 3.0f)), 0);
	helper.create();
	...
	while (!glfwWindowShouldClose(helper.getWindow())) {
		...
		shadowTransforms.push_back(shadowProj * glm::lookAt(lightPos, lightPos + glm::vec3(1.0, -1.0, 0.0), glm::vec3(0.0, 0.0, -1.0)));
		shadowTransforms.push_back(shadowProj * glm::lookAt(lightPos, lightPos + glm::vec3(1.0, 0.0, 1.0), glm::vec3(0.0, -1.0, 0.0)));
		shadowTransforms.push_back(shadowProj * glm::lookAt(lightPos, lightPos + glm::vec3(1.0, 0.0, -1.0), glm::vec3(0.0, -1.0, 0.0)));
